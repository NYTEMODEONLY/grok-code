...
export class FrameworkPatterns {
  constructor() {
    this.patterns = {
      react: {
        ...
        patterns: {
          hooks: {
            ...
            useMemo: {
              ...
              description:
                'React useMemo hook for memoizing expensive computations',
              example:
            ...
            useContext: {
              ...
              conventions: [
                'Prefer useContext over Consumer components',
                'Create custom hooks for complex context logic',
              ],
            },
          },
          components: {
            functionalComponent: {
              ...
              example:
                'function MyComponent(props) { return <div>Hello</div>; }',
              conventions: [
            ...
            arrowComponent: {
              ...
              example:
                'const MyComponent = (props) => { return <div>Hello</div>; };',
              conventions: [
          ...
          props: {
            ...
            defaultProps: {
              ...
              conventions: [
                ...
                'Use defaultProps sparingly with destructuring',
              ],
            },
          },
        },
        conventions: {
          fileNaming: [
            'Use PascalCase for component files (.jsx, .tsx)',
            'Use index.js for folder-based components',
          ],
          folderStructure: [
            'Group related components in folders',
            'Use descriptive folder names',
            'Separate hooks, utils, and types',
          ],
          stateManagement: [
      ...
      vue: {
          ...
          compositionApi: {
            ...
            reactive: {
              ...
              conventions: [
                ...
                'Avoid mutating reactive objects directly',
            ...
            ref: {
              ...
              conventions: [
                ...
                'Access value with .value in setup',
                'Use .value in template automatically',
              ],
            },
            computed: {
          ...
          template: {
            directives: {
              vIf: {
                ...
                conventions: [
                  'Use v-else/v-else-if for alternatives',
                  'Prefer computed properties for conditions',
                  'Consider v-show for frequent toggling',
                ],
              },
              vFor: {
                pattern: /v-for\s*=\s*["'][^"']*["']/,
                ...
                conventions: [
                  'Always use :key for performance',
                  'Use track-by for simple arrays',
                  'Prefer computed properties for filtered lists',
                ],
              },
              vModel: {
                pattern: /v-model\s*=\s*["'][^"']*["']/,
                ...
                conventions: [
                  ...
                  'Can use modifiers (.lazy, .number, .trim)',
                  'Supports custom v-model in components',
                ],
              },
            },
          },
        ...
        conventions: {
          fileNaming: [
            'Use PascalCase for component files (.vue)',
            'Use kebab-case for component names in templates',
          ],
          folderStructure: [
            'Group components by feature',
            'Separate composables, utils, and types',
          ...
          performance: [
            ...
            'Implement proper key props in v-for',
      ...
      angular: {
          ...
          decorators: {
            ...
            injectable: {
              ...
              conventions: [
                ...
                'Specify provider scope explicitly',
            ...
            input: {
              ...
              conventions: [
                ...
                'Use setter/getter for complex logic',
              ],
            },
            output: {
          ...
          lifecycle: {
            ...
            ngOnChanges: {
              ...
              conventions: [
                ...
                'Use SimpleChanges for performance',
        ...
        conventions: {
          fileNaming: [
            ...
            'Use .component.ts, .service.ts, .module.ts suffixes',
          ],
          folderStructure: [
            'Organize by feature modules',
            'Separate core, shared, and feature modules',
            'Use barrels (index.ts) for clean imports',
          ],
          stateManagement: [
          ...
          testing: [
            ...
            'Test components, services, and pipes separately',
      ...
      express: {
          ...
          routing: {
            ...
            middleware: {
              ...
              conventions: [
                ...
                'Apply route-specific middleware after general middleware',
              ],
            },
          },
          errorHandling: {
            errorMiddleware: {
              ...
              conventions: [
                'Use four parameters (err, req, res, next)',
        ...
        conventions: {
          fileStructure: [
            ...
            'Use app.js for main application setup',
            'Organize routes by feature',
          ],
          middleware: [
            'Use middleware for cross-cutting concerns',
            'Order middleware logically',
            'Create custom middleware for business logic',
          ],
          errorHandling: [
      ...
      django: {
        ...
        patterns: {
          models: {
            modelClass: {
              ...
              conventions: [
                ...
                'Define __str__ method for admin display',
              ],
            },
            modelMethods: {
              ...
              conventions: [
                ...
                'Use __unicode__ for Python 2 compatibility',
                'Override save() and delete() when needed',
              ],
            },
          },
          views: {
            functionBased: {
              ...
              conventions: [
                ...
                'Handle GET and POST appropriately',
                'Return HttpResponse or render shortcut',
              ],
            },
            classBased: {
              ...
              conventions: [
                'Inherit from appropriate base view',
          ...
          urls: {
            urlPatterns: {
              ...
              conventions: [
                'Use path() over url()',
                'Include name parameter for reverse URLs',
        ...
        conventions: {
          projectStructure: [
            ...
            'Use apps for feature organization',
            'Follow Django project layout conventions',
          ],
          models: [
          ...
          testing: [
            ...
            'Use Django test client for views',
  ...
  suggestImprovements(detectedPatterns, frameworkName) {
    ...
    if (frameworkName === 'react') {
      if (
        patternNames.includes('useEffect') &&
        !detectedPatterns.some(
          (p) => p.category === 'hooks' && p.pattern === 'useCallback'
        )
      ) {
        suggestions.push({
          type: 'performance',
          message:
            'Consider using useCallback for functions passed to child components to prevent unnecessary re-renders',
          pattern: 'useCallback',
        });
      }

      if (
        !patternNames.includes('propTypes') &&
        patternNames.some((p) => p.category === 'components')
      ) {
        suggestions.push({
          type: 'maintainability',
          message:
            'Consider adding PropTypes to your components for better type checking and documentation',
          pattern: 'propTypes',
        });
      }
    }
    ...
    if (frameworkName === 'vue') {
      if (
        patternNames.includes('data') &&
        !detectedPatterns.some(
          (p) => p.category === 'optionsApi' && p.pattern === 'computed'
        )
      ) {
        suggestions.push({
          type: 'performance',
          message:
            'Consider using computed properties for derived data instead of methods',
          pattern: 'computed',
        });
      }
    }
    ...
    if (frameworkName === 'express') {
      if (
        !patternNames.includes('errorMiddleware') &&
        patternNames.some((p) => p.category === 'routing')
      ) {
        suggestions.push({
          type: 'reliability',
          message:
            'Consider adding error handling middleware to properly handle application errors',
