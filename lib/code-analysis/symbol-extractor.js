...
export class SymbolExtractor {
  ...
  extractSymbols(astData, language) {
    ...
    // Handle skipped files (unknown languages)
    if (astData && astData.metadata && astData.metadata.skipped) {
      return {
        functions: [],
        classes: [],
        variables: [],
        ...
        metadata: {
          ...
          skipped: true,
          reason: astData.metadata.reason,
        },
      };
    }

    if (!astData) {
      throw new Error('AST data is required');
    }
